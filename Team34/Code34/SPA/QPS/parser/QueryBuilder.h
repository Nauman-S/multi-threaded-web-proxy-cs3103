...
private:
    ...
    std::unordered_set<RefType> stmt_ref_types = std::unordered_set<RefType>(
        { RefType::kAssignRef, RefType::kCallRef, RefType::kIfRef, RefType::kPrintRef, RefType::kReadRef, RefType::kWhileRef });
