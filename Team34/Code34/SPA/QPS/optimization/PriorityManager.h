...
private:
    ...
    std::unordered_map<std::pair<ClauseType, int>, Priority, pair_hash> priority_map_ = {
        ...
        {std::make_pair(ClauseType::kModifiesPRel, 1), 1},
        {std::make_pair(ClauseType::kUsesPRel, 1), 1},

        {std::make_pair(ClauseType::kModifiesSRel, 1), 2},
        {std::make_pair(ClauseType::kUsesSRel, 1), 2},

        {std::make_pair(ClauseType::kAssignPattern, 1), 3},
        ...
        {std::make_pair(ClauseType::kWith, 1), 4},

        {std::make_pair(ClauseType::kParentTRel, 1), 5},
        {std::make_pair(ClauseType::kFollowsTRel, 1), 5},
        {std::make_pair(ClauseType::kCallsTRel, 1), 5},
        {std::make_pair(ClauseType::kNextTRel, 1), 5},
        {std::make_pair(ClauseType::kAffectsTRel, 1), 5},

        {std::make_pair(ClauseType::kParentRel, 2), 0},
        {std::make_pair(ClauseType::kFollowsRel, 2), 0},
        {std::make_pair(ClauseType::kCallsRel, 2), 0},
        {std::make_pair(ClauseType::kNextRel, 2), 0},

        {std::make_pair(ClauseType::kModifiesPRel, 2), 1},
        {std::make_pair(ClauseType::kUsesPRel, 2), 1},

        {std::make_pair(ClauseType::kModifiesSRel, 2), 2},
        {std::make_pair(ClauseType::kUsesSRel, 2), 2},

        {std::make_pair(ClauseType::kAssignPattern, 2), 3},
        {std::make_pair(ClauseType::kIfPattern, 2), 3},
        {std::make_pair(ClauseType::kWhilePattern, 2), 3},
        {std::make_pair(ClauseType::kAffectsRel, 2), 3},

        {std::make_pair(ClauseType::kWith, 2), 4},

        {std::make_pair(ClauseType::kParentTRel, 2), 5},
        {std::make_pair(ClauseType::kFollowsTRel, 2), 5},
        {std::make_pair(ClauseType::kCallsTRel, 2), 5},
        {std::make_pair(ClauseType::kNextTRel, 2), 5},
        {std::make_pair(ClauseType::kAffectsTRel, 2), 5}
    };
