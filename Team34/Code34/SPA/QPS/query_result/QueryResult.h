...
protected:
	...
	bool MergeSetResult(std::shared_ptr<SetRes> other_set);
	bool MergeTableResult(std::shared_ptr<TableRes> other_table);

public:
	bool MergeResult(std::shared_ptr<ResWrapper> res_wrapper);
