...
map<Procedure, shared_ptr<ControlFlowNode>> CFGBuilder::GenerateCFG(string& source_filename) {
	...
	std::shared_ptr<std::vector<SourceToken>> tokens = lexer.GetAllTokens();
...
pair<Procedure, shared_ptr<ControlFlowNode>> CFGBuilder::GenerateProcedureCFG(std::shared_ptr<std::vector<SourceToken>> tokens, int& token_idx, int& line_idx) {
	// procedure xx {
...
shared_ptr<ControlFlowNode> CFGBuilder::GenerateStatementCFG(std::shared_ptr<std::vector<SourceToken>> tokens, int& token_idx, int& line_idx, shared_ptr<ControlFlowNode> prev_end) {
...
shared_ptr<ControlFlowNode> CFGBuilder::GenerateSimpleCFG(std::shared_ptr<std::vector<SourceToken>> tokens, int& token_idx, int& line_idx, shared_ptr<ControlFlowNode> prev_end) {
	if (prev_end->isEmpty()) {
...
shared_ptr<ControlFlowNode> CFGBuilder::GenerateWhileCFG(std::shared_ptr<std::vector<SourceToken>> tokens, int& token_idx, int& line_idx, shared_ptr<ControlFlowNode> prev_end) {
...
shared_ptr<ControlFlowNode> CFGBuilder::GenerateIfCFG(std::shared_ptr<std::vector<SourceToken>> tokens, int& token_idx, int& line_idx, shared_ptr<ControlFlowNode> prev_end) {
	shared_ptr<ControlFlowNode>* head_ptr;
	if (prev_end->isEmpty()) {
