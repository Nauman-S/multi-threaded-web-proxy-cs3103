...
public:
	...
	std::shared_ptr<std::vector<std::pair<std::shared_ptr<StmtNum>, std::shared_ptr<Procedure>>>> GetAllCallsStatementProcedurePairs();
	std::shared_ptr<std::vector<std::pair<std::shared_ptr<StmtNum>, std::shared_ptr<Variable>>>> GetAllPrintStatementVariablePairs();
	std::shared_ptr<std::vector<std::pair<std::shared_ptr<StmtNum>, std::shared_ptr<Variable>>>> GetAllReadStatementVariablePairs();

	void Clear();
private:
	std::shared_ptr<std::vector<std::pair<std::shared_ptr<StmtNum>, std::shared_ptr<Procedure>>>> GenerateStatementProcedurePairs(std::unordered_map<StmtNum, Procedure>& map);
	std::shared_ptr<std::vector<std::pair<std::shared_ptr<StmtNum>, std::shared_ptr<Variable>>>> GenerateStatementVariablePairs(std::unordered_map<StmtNum, Variable>& map);
